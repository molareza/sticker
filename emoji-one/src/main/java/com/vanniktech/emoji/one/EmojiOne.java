...
public class EmojiOne extends Emoji {
  ...
  public EmojiOne(@NonNull final int[] codePoints, final int x, final int y, final boolean isDuplicate) {
  ...
  public EmojiOne(final int codePoint, final int x, final int y, final boolean isDuplicate) {
