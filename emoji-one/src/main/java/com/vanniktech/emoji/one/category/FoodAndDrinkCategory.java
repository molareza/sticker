...
@SuppressWarnings("PMD.MethodReturnsInternalArray") public final class FoodAndDrinkCategory implements EmojiCategory {
  private static final EmojiOne[] DATA = new EmojiOne[] {
    ...
    new EmojiOne(new int[] { 0x1F336, 0xFE0F }, 6, 44),
    new EmojiOne(0x1F952, 41, 50),
    new EmojiOne(0x1F966, 42, 18),
    ...
    new EmojiOne(0x1F963, 42, 15),
    new EmojiOne(0x1F957, 42, 3),
    new EmojiOne(0x1F37F, 8, 13),
    new EmojiOne(0x1F96B, 42, 23),
    ...
    new EmojiOne(0x1F95F, 42, 11),
    new EmojiOne(0x1F960, 42, 12),
    new EmojiOne(0x1F961, 42, 13),
    ...
    new EmojiOne(0x1F964, 42, 16),
    new EmojiOne(0x1F962, 42, 14),
    new EmojiOne(new int[] { 0x1F37D, 0xFE0F }, 8, 11),
